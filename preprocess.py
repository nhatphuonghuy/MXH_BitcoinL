...
dir='/kaggle/input/bitcoinm'
data_dir='/kaggle/input/bitcoinm'
...
def generate_sequences(args):
    ...
    # Save
    print("Saving data...")
    np.save(f'/kaggle/working/MXH_BitcoinL/data/{args.data}/out_sentences_{length}.npy', res_out)
    np.save(f'/kaggle/working/MXH_BitcoinL/data/{args.data}/in_sentences_{length}.npy', res_in)
    torch.save(lens_out, f'/kaggle/working/MXH_BitcoinL/data/{args.data}/out_sentences_len_{length}.pt')
    torch.save(lens_in, f'/kaggle/working/MXH_BitcoinL/data/{args.data}/in_sentences_len_{length}.pt')            
    print("Done!")
    
if __name__ == '__main__':
    argparser = argparse.ArgumentParser()
    argparser.add_argument('--data', type=str, default='bitcoinm')
